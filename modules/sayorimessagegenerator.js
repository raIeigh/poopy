module.exports = function (msg, fixedchoice) {
    ...
    const what = ['boobs', 'breasts', 'cleavage', 'bosoms', 'pussy', 'vagina', 'ass', 'ass', 'ass', 'ass', 'ass', 'butt', 'buttocks', 'bum', 'bussy', 'boy pussy', 'penis', 'cock', 'dick', 'balls', 'testicles', 'scrotum', 'perineum', 'thighs', 'legs', 'mouth', 'feet', 'cum', 'foreskin', 'pubes', 'tits', 'titties', 'areolas', 'milkers', 'goat bussy']
    const options = [
