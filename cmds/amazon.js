module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('image') && !(poopy.vars.gifFormats.find(f => f === type.ext))) {
            ...
            var amazon = await poopy.modules.Jimp.read(`templates/amazon.png`)
            var ystars = await poopy.modules.Jimp.read(`templates/ystars.png`)
            var wstars = await poopy.modules.Jimp.read(`templates/wstars.png`)
            var amazonemlink = await poopy.modules.Jimp.loadFont('templates/fonts/AmazonEmberLink/AmazonEmberLink.fnt')
            var amazonemsmall = await poopy.modules.Jimp.loadFont('templates/fonts/AmazonEmberSmall/AmazonEmberSmall.fnt')
            var amazonembig = await poopy.modules.Jimp.loadFont('templates/fonts/AmazonEmberBig/AmazonEmberBig.fnt')
