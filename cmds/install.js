module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('image') && !(poopy.vars.gifFormats.find(f => f === type.ext))) {
            ...
            await poopy.functions.execPromise(`ffmpeg -i templates/install.png -filter_complex "[0:v]scale=${width}:-1[install]" -map "[install]" ${filepath}/install.png`)
