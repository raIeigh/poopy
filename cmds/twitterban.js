module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('image') && !(poopy.vars.gifFormats.find(f => f === type.ext))) {
            ...
            var twitter = await poopy.modules.Jimp.read(`templates/twitter.png`)
            var tnr = await poopy.modules.Jimp.loadFont('templates/fonts/TimesNewRoman/TimesNewRoman.fnt')
            var arialbold = await poopy.modules.Jimp.loadFont('templates/fonts/ArialBold/ArialBold.fnt')
            var arialblue = await poopy.modules.Jimp.loadFont('templates/fonts/ArialBlue/ArialBlue.fnt')
