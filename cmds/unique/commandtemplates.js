module.exports = {
    ...
    subcommands: [{"name":"list","args":[],"description":"Sends a navigable embed with a list of all command templates made by the users of Poopy."},{"name":"search","args":[{"name":"query","required":true,"specifarg":false,"orig":"<query>"}],"description":"Searches for every command in the command database that matches the query."},{"name":"register","args":[{"name":"name","required":true,"specifarg":false,"orig":"<name>"},{"name":"phrase","required":true,"specifarg":false,"orig":"<phrase>"},{"name":"description","required":false,"specifarg":true,"orig":"{-description <text>}"},{"name":"image","required":false,"specifarg":true,"orig":"[-image <url>]"},{"name":"syntax","required":false,"specifarg":true,"orig":"[-syntax <text>]"}],"description":"Registers the command with the respective name, description and syntax (if supplied), it'll then be assigned an ID that can be used to import it via the `localcmds` command."},{"name":"edit","args":[{"name":"id","required":true,"specifarg":false,"orig":"<id>"},{"name":"name","required":false,"specifarg":true,"orig":"[-name <text>]"},{"name":"phrase","required":false,"specifarg":true,"orig":"[-phrase <text>]"},{"name":"description","required":false,"specifarg":true,"orig":"[-description <text>]"},{"name":"image","required":false,"specifarg":true,"orig":"[-image <url>]"},{"name":"syntax","required":false,"specifarg":true,"orig":"[-syntax <text>]"}],"description":"Allows you to edit the command with the respective ID in the database, if it exists and you made it."},{"name":"delete","args":[{"name":"id","required":true,"specifarg":false,"orig":"<id>"}],"description":"Permanently deletes the command from the database with the respective ID, if it exists and YOU made it."}],
