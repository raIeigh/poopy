module.exports = {
    ...
    help: {
        name: 'commandassets/cmdassets <option>',
        value: 'Gives you access to a global database of command assets you can use in your servers! Anyone can contribute to it. Use the command alone for more info.'
    },
    cooldown: 5000,
    type: 'Unique'
}