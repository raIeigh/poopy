module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('video')) {
            ...
            var novecento = await modules.Jimp.loadFont(`assets/fonts/Novecento/Novecento.fnt`)
            transparent.resize(101, 28)
            await transparent.print(novecento, 0, 0, { text: modules.Discord.Util.cleanContent(text, msg), alignmentX: modules.Jimp.HORIZONTAL_ALIGN_CENTER, alignmentY: modules.Jimp.VERTICAL_ALIGN_MIDDLE }, 101, 28)
