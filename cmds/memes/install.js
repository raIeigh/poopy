module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('image') && !(vars.gifFormats.find(f => f === type.ext))) {
            ...
            await execPromise(`ffmpeg -i assets/install.png -filter_complex "[0:v]scale=${width}:-1[install]" -map "[install]" ${filepath}/install.png`)
