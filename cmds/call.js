module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (type.mime.startsWith('image') && !(poopy.vars.gifFormats.find(f => f === type.ext))) {
            ...
            var call = await poopy.modules.Jimp.read(`templates/call.png`)
            var helvetica = await poopy.modules.Jimp.loadFont('templates/fonts/HelveticaLight/HelveticaLight.fnt')
            ...
            var bscale = await poopy.functions.execPromise(`ffprobe -v error -select_streams v:0 -show_entries stream=width,height -of csv=s=x:p=0 templates/call.png`)
