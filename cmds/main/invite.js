module.exports = {
  ...
  execute: async function (msg) {
    ...
    if (process.env.BOTWEBSITE) {
        ...
        await msg.reply(`Bot invite link: <https://discord.com/oauth2/authorize?client_id=${poopy.bot.user.id}&scope=bot%20applications.commands&permissions=275415166152>`).catch(() => { })
    }
  },
  help: {
    name: 'invite',
