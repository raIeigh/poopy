module.exports = {
    ...
    execute: async function (msg, args) {
        ...
        if (audio && audio2) {
            ...
            await execPromise(`ffmpeg -i ${filepath}/${filename} -vn -ac 1 -ar 44100 ${filepath}/carrier.wav`)
            await execPromise(`ffmpeg -i ${filepath}/${filename2} -vn -ac 1 -ar 44100 ${filepath}/modulator.wav`)
