module.exports = { 
 ...
             return { 
                 posturl: `https://e926.net/post/show/${result.id}`, 
                 url: result.file.url, 
                 title: tags, 
 ...
             else return { 
                 "title": "E926 Post Search Results For " + search, 
 ...
     }, 
     help: { 
         name: 'e926 <query> [-page <number>]', 
         value: 'furry porn without the porn' 
     }, 
     cooldown: 2500, 
     type: 'Fetching' 
 }module.exports = { 
 ...
     }, 
     help: { 
         name: 'e926 <query> [-page <number>] (nsfw channel only)', 
