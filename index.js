async function main() {
    ...
    app.use(function (req, res) {
        /*fs.readdirSync('errorpages').forEach(page => {
            res.status(Number(page.replace('.html', ''))).sendFile(`${__dirname}/errorpages/${page}`)
        })*/
        ...
        res.status(500).sendFile(`${__dirname}/errorpages/500.html`)
    })
    ...
    setInterval(function () {
        axios.get(`https://poopies-for-you.herokuapp.com`)
    }, 300000)
}
