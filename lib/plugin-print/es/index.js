...
var _graphemes = new GraphemeSplitter()
...
function printText(font, x, y, text, defaultCharWidth) {
  var chars = _graphemes.splitGraphemes(text)
  ...
  for (var i = 0; i < chars.length; i++) {
    ...
    var kerning = fontKerning && fontKerning[chars[i + 1]] ? fontKerning[chars[i + 1]] : 0;
