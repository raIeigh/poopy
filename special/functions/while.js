module.exports = {
  ...
  desc: "Repeats the phrase while the condition is met. If the separator is specified, it'll separate each repetition with the separator.",
  func: async function (matches, msg, isBot, _, opts) {
    ...
    var phrase = await poopy.functions.getKeywordsFor(split[1] ?? '', msg, isBot).catch(() => { }) ?? ''
