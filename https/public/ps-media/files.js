...
(async () => {
    var ps = await $.getJSON('https://raw.githubusercontent.com/raIeigh/ps-media-json/main/psfiles.json')
    psFiles = ps.data
...
repeatImage.src = './resources/repeat.png'
